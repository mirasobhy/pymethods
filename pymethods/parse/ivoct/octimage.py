...
class OCTImage(arrays.structured.Image):
...
if __name__ == "__main__":
    ...
    if False:
        path = pt.Path(
            r'D:\Github\pymethods\testsReconstruction\test_1\oct\pr2_00000.jpg'
        )
        oct_image = OCTImage(path)
    ...
    if True:
        path_bifur = r'D:\Github\pymethods\testsReconstruction\test_1\oct\pr2_00059.jpg'
        oct_image = OCTImage(path_bifur)
